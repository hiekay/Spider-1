...
//				String paramName = "";
	 ...
	 * @return  商品信息列表
	 */
	public static List<Clothes> searchListInfo(Elements results,Response response){
	...
	public static List<Clothes> getJson(String url){
        ...
        //解析,
        JSONObject jsonObj = JSON.parseObject(result).getJSONObject("result").getJSONObject("wall"); 
        ...
        for(int i=0;i<num;i++){
    		...
    		clothes.setOriginPrice(Obj.get("orgPrice").toString().replace("￥",""));
